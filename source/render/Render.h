...
typedef enum {
	RENDER_REALTIME_PALETTES    = 0b0000000000000001,
	RENDER_MIDFRAME_PALETTESWAP = 0b0000000000000010,
	RENDER_SCANLINE_DEFORMATION = 0b0000000000000100,
	RENDER_STEREOSCOPIC_3D      = 0b0000000000001000,  // 3DS-specific features
	RENDER_BOTTOM_TOUCHSCREEN   = 0b0000000000010000,
	RENDER_VMU_SCREEN           = 0B0000000000100000   // Dreamcast-specific features
